...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'posed_8_tc_coco_sequential_train.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'posed_8_tc_coco_sequential_test.json',
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
             init_kwargs=dict(
                 entity='',
                 project='',
                 name='Faster_TC8_sequential_480p_LossWeight_noRPN'
             ),
             interval=100
             )
