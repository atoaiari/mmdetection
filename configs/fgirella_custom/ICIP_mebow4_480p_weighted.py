...
train_pipeline = [
    ...
    dict(type='RandomFlip', flip_ratio=0.00000000001),
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='RandomFlip', flip_ratio=0.0000000001),
            dict(type='Normalize', **img_norm_cfg),
            dict(type='Pad', size_divisor=32),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/mebow_coco/mebow_coco_fixed_train.json',
        # ann_file=data_root + 'mebow_coco_keypoints_train_smaller.json',
        img_prefix=data_root + 'images/train2017',
        pipeline=train_pipeline,
        classes=CLASSES),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/mebow_coco/mebow_coco_fixed_val.json',
        # ann_file=data_root + 'mebow_coco_keypoints_val_smaller.json',
