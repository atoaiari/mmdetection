...
class OrientationFasterRoiHead(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None,
                 orientation_bbox_roi_extractor=None,
                 orientation_head=None):
        super(OrientationFasterRoiHead, self).__init__(
        ...
        self.init_orientation_head(orientation_bbox_roi_extractor, orientation_head)
    ...
    def init_orientation_head(self, orientation_bbox_roi_extractor, orientation_head):
        """Initialize orientation head and box roi extractor.
    ...
    def forward_train(self,
        ...
        Args:
            ...
            gt_orientations (list[Tensor]): orientation labels corresponding to each box
        ...
        for name, value in loss_orientation.items():
            losses['orientation.{}'.format(name)] = value * 100
    ...
    def simple_test(self,
        ...
        # print(f"Simple test without augmentation, {len(det_bboxes)} = len of det_bboxes = n. imgs")
